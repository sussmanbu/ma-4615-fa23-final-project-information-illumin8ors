...
big_picture_barchart <- big_picture_df |> 
  ...
  geom_col() + 
  labs(title = "Average Summed Weekly Use of Cocaine, Heroin, and Crack across 58,034 NSDUH Survey Respondents", x = "Respondent Race", y = "Average use (number of days per week)") + 
  scale_fill_viridis_d() +  
